...
public class KeyboardViewLandscape extends LinearLayout implements OnClickListener {

	private MainActivity mainActivity;
	
	private Button BT0, BT1, BT2, BT3, BT4, BT5, BT6, BT7, BT8, BT9, saveBT, clearBT;

	public KeyboardViewLandscape(MainActivity mainActivity) {
		super(mainActivity);
		this.mainActivity = mainActivity;
		
		inflate(mainActivity, R.layout.view_keyborad_landscape, this);
